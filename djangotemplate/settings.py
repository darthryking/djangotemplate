...
SERVER_EMAIL = 'server@djangotemplate.com'
DEFAULT_FROM_EMAIL = 'Django Template <no-reply@djangotemplate.com>'
EMAIL_SUBJECT_PREFIX = '[Django Template Server] '
...
MIDDLEWARE_CLASSES = (
    ...
    'utils.middleware.BanHammerMiddleware',
